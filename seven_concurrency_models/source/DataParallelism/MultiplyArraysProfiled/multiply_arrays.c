...
// START:profiling
  ...
  clEnqueueNDRangeKernel(queue, kernel, 1, NULL, &work_units, //<label id="code.timingevent"/>
...
// START:profiling
  cl_ulong starttime;
  clGetEventProfilingInfo(timing_event, CL_PROFILING_COMMAND_START, //<label id="code.commandstart"/>
    sizeof(cl_ulong), &starttime, NULL);
  cl_ulong endtime;
  clGetEventProfilingInfo(timing_event, CL_PROFILING_COMMAND_END, //<label id="code.commandend"/>
